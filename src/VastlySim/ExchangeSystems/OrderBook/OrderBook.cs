...
public class OrderBook
{
    ...
    private List<Order> _bids = new List<Order>();
    private List<Order> _asks = new List<Order>();
    ...
    {
        var topBid = _bids.Count > 0 ? _bids[0] : null;
        var topAsk = _asks.Count > 0 ? _asks[0] : null;
